...
urlpatterns = [
    ...
    path("<int:start_gw>/<int:end_gw>/<str:combinations>/<int:min_num_fixtures>", views.fixture_planner, name='fixture-planner-gw1-gw2-combi-min_num_fixtures'),
    path("<int:start_gw>/<int:end_gw>/<str:combinations>/<int:teams_to_play>/<int:teams_to_check>", views.fixture_planner, name='fixture-planner-gw1-gw2-combi-teamstocheck-teamstoplay'),
